    ...
    return (
        <div className="navbar bg-base-100 shadow-sm px-3 lg:px-10">
            ...
            <div className="navbar-end">
                <Link to='https://github.com/Azhar-Uddin-dev/' className="btn bg-gradient-to-r from-[#632EE3] to-[#9F62F2] text- text-white font-bold"><span><img src={github} alt="" /></span>Contribute</Link>
            </div>
        </div>
    );
};
